...
#pragma warning(default : 26495)
	...
	friend void LanClient::RecvProc(Session* pSession, int numberOfBytesTransferred);
	friend BOOL LanClient::SendPost(Session* pSession);
	friend void LanClient::SendProc(Session* pSession, DWORD dwNumberOfBytesTransferred);
	friend void LanClient::ReleaseSession(Session* pSession);
};
